...
export default async function handler(req) {
  try {
    ...
    const LAYOUTS = {
      ...
      "4": { img: {x:45, y:407, w:866, h:1327}, text1: {x:512, y:1850, size:55}, text2: {x:512, y:1600, size:55} },
      "5": { img: {x:0, y:200, w:795, h:1327}, text1: {x:512, y:1850, size:55}, text2: {x:512, y:1600, size:55} },
      "6": { img: {x:0, y:200, w:795, h:1327}, text1: {x:512, y:1850, size:55}, text2: {x:512, y:1600, size:55} },
      "7": { img: {x:0, y:200, w:795, h:1327}, text1: {x:512, y:1850, size:55}, text2: {x:512, y:1600, size:55} },
