...
export default async function handler(req) {
  try {
    ...
    const LAYOUTS = {
      ...
      "4": { img: {x:45, y:407, w:866, h:1327}, text1: {x:512, y:350, size:55}, text2: {x:650, y:1700, size:55} },
      "5": { img: {x:200, y:450, w:866, h:1327}, text1: {x:450, y:400, size:55}, text2: {x:400, y:1900, size:55} },
      "6": { img: {x:0, y:200, w:866, h:1327}, text1: {x:512, y:1850, size:55}, text2: {x:512, y:1600, size:55} },
