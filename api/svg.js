...
export default async function handler(req) {
  try {
    ...
    const LAYOUTS = {
      "1":   { img: {x:51, y:462, w:795, h:1204}, de: {y:180, size:42}, text: {x:700, y:1700, size:55}, ef: {x:512, y:950, size:130, rot:-5} },
      "2":   { img: {x:51, y:462, w:795, h:1204}, de: {y:180, size:42}, text: {x:700, y:1700, size:55}, ef: {x:512, y:950, size:130, rot:-5} },
      "3":   { img: {x:51, y:462, w:795, h:1204}, de: {y:180, size:42}, text: {x:700, y:1700, size:55}, ef: {x:512, y:950, size:130, rot:-5} },
